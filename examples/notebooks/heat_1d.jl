...
# ╔═╡ 35dfd6e0-e30b-4530-809b-34ea602bcff1
mean(f_ic)
...
function plot_interactive(fig, f_cond)
    ...
    return on(time_slider.value) do val
        time_idx[] = val
    end
end
...
# ╔═╡ 1d862288-3702-4e42-8b4d-2bdc59ddd546
bc_obs
...
begin
    ...
    f_moar = condition_on_observation(f_ic_bc, ℒ_moar, Y_pde_moar, noise = 1.0e-8)
end
...
f_FVM = condition_on_observation(f_ic_bc, ℒ_FVM, Y_FVM, noise = 1.0e-8)
